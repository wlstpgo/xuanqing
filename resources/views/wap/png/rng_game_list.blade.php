    ...
    <div class="m_mgList">
        ...
        <ul class="clear textCenter">
                ...
                @foreach($data as $item)
                    ...
                    ?>
                        <li>
                            <a href="{{ route('png.playGame') }}?game_code={{ $item->tcgGameCode }}?platform=html5" class="link-box">
                                <div class="link-box-pic">
                                    <img src="http://images.uxgaming.com/TCG_GAME_ICONS/PNG/{{ $item->tcgGameCode }}.png" alt="">
                                </div>
