...
class MemberOfflineGameRecordController extends DailiBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('daili.member_offline_game_record.index', compact('data', 'playerName','start_at', 'end_at', 'api_type', 'total_netAmount', 'total_betAmount', 'name','total_validBetAmount'));
    }
}
